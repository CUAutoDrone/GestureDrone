...
MODEL_PATH = os.path.join(BASE_DIR, "../gesture_cv/GestureData/gesture_classifier.pt")
LABEL_MAP_PATH = os.path.join(BASE_DIR, "../gesture_cv/GestureData/label_map.json")
        ...
        if results.multi_hand_landmarks:
            for hand_landmarks in results.multi_hand_landmarks:
                ...
                if command_text != self.last_command and command_text != "UNKNOWN":
                    self.get_logger().info(f"Gesture: {stable_prediction} -> Command: {command_text}")
                    msg = String()
