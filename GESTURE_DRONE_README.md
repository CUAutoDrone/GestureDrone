...
The system uses an isolated Python virtual environment at `gesture_env` with pinned dependencies:
...
- Verify venv: `gesture_env/bin/python3 -c "import rclpy; print('OK')"`
...
- **Launch file**: Uses venv Python interpreter at `gesture_env/bin/python3`
